...
def main() -> int:
    ...
    steps = [
        ...
        ("Категория дропа", callback(500, "cat:drop")),
        ...
        ("Черновик рассылки", message(1, "/broadcast ДРОП СЕГОДНЯ В 19:00 — размеры разберут за час")),
        ...
        ("Описание", message(1, "Кепка второго дропа. Мелкая партия, добивать не будем.")),
